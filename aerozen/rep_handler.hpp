...
public:
    ...
    // Documentation inherited.
    bool RunLocalCallback(const ProtoMsg& _msgReq, ProtoMsg& _msgRep) {
        ...
        const auto msgReq = google::protobuf::DynamicCastMessage<Req>(&_msgReq);
        auto msgRep = google::protobuf::DynamicCastMessage<Rep>(&_msgRep);
