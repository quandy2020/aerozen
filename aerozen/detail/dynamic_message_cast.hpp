...
#ifndef AEROZEN_DETAIL_DYNAMIC_MESSAGE_CAST_HPP_
#define AEROZEN_DETAIL_DYNAMIC_MESSAGE_CAST_HPP_

#include <memory>

#include <google/protobuf/message.h>

namespace aerozen::detail {
...
std::unique_ptr<MsgT> dynamic_message_cast(
    ...
    if (converted) {
        // transfer ownership to a new unique_ptr object by releasing from old
        // one
...
#endif  // AEROZEN_DETAIL_DYNAMIC_MESSAGE_CAST_HPP_
