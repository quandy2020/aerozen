...
struct ParametersClientPrivate {
    ParametersClientPrivate(const std::string& _serverNamespace,
                            unsigned int _timeoutMs)
        : serverNamespace{_serverNamespace}, timeoutMs{_timeoutMs} {}
...
//////////////////////////////////////////////////
ParametersClient::ParametersClient(const std::string& _serverNamespace,
                                   unsigned int _timeoutMs)
    : dataPtr{std::make_unique<ParametersClientPrivate>(_serverNamespace,
                                                        _timeoutMs)} {}

//////////////////////////////////////////////////
static ParameterResult getParameterCommon(
    const ParametersClientPrivate& _dataPtr, const std::string& _parameterName,
    ...
    if (!_dataPtr.node.Request(service, req, _dataPtr.timeoutMs,
                               _parameterValue, result)) {
        return ParameterResult{ParameterResultType::ClientTimeout,
                               _parameterName};
    }
    if (!result) {
...
//////////////////////////////////////////////////
ParameterResult ParametersClient::Parameter(
...
//////////////////////////////////////////////////
ParameterResult ParametersClient::SetParameter(
...
//////////////////////////////////////////////////
ParameterResult ParametersClient::DeclareParameter(
    const std::string& _parameterName, const google::protobuf::Message& _msg) {
    bool result{false};
...
//////////////////////////////////////////////////
msgs::ParameterDeclarations ParametersClient::ListParameters() const {
    bool result{false};
