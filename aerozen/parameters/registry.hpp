...
#ifndef AEROZEN_PARAMETERS_REGISTRY_HPP_
#define AEROZEN_PARAMETERS_REGISTRY_HPP_
...
public:
    ParameterResult SetParameter(
        const std::string& _parameterName,
        std::unique_ptr<google::protobuf::Message> _value);
    /// \brief Pointer to implementation.
private:
    std::unique_ptr<ParametersRegistryPrivate> dataPtr;
};
}  // namespace aerozen::parameters

#endif  // AEROZEN_PARAMETERS_REGISTRY_HPP_
