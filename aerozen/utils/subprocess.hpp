 ...
 */
 ...
 class Subprocess
 {
   ...
   public: Subprocess(const std::vector<std::string> &_commandLine,
     ...
     Subprocess(_commandLine, aerozen::utils::envStringsToMap(_environment))
   {
   }
   ...
   private: void Create()
   {
     ...
     auto environmentStr = aerozen::utils::envMapToStrings(this->environment);
   ...
   protected: aerozen::utils::EnvironmentMap environment;
