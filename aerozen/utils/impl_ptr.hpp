...
#ifndef AEROZEN_UTILS_IMPL_PTR_HPP_
#define AEROZEN_UTILS_IMPL_PTR_HPP_

#include <memory>
#include <utility>

#include "aerozen/utils/detail/default_ops.hpp"
...
#define AEROZEN_UTILS_IMPL_PTR_FWD(ImplementationClass, memberName) \
    AEROZEN_UTILS_WARN_IGNORE__DLL_INTERFACE_MISSING                \
private:                                                            \
    ::aerozen::utils::ImplPtr<ImplementationClass> memberName;      \
    AEROZEN_UTILS_WARN_RESUME__DLL_INTERFACE_MISSING

/// \brief Add a private UniqueImplPtr to a class as dataPtr.
///  This variant takes a forward-declared ImplementationClass as the impl.
#define AEROZEN_UTILS_UNIQUE_IMPL_PTR_FWD(ImplementationClass, memberName) \
    AEROZEN_UTILS_WARN_IGNORE__DLL_INTERFACE_MISSING                       \
private:                                                                   \
    ::gz::utils::UniqueImplPtr<ImplementationClass> memberName;            \
    AEROZEN_UTILS_WARN_RESUME__DLL_INTERFACE_MISSING

/// \brief Add a private ImplPtr to a class as dataPtr.
///  This variant forward-declares Class::Implementation as the impl.
#define AEROZEN_UTILS_IMPL_PTR(memberName) \
public:                                    \
    class Implementation;                  \
    AEROZEN_UTILS_IMPL_PTR_FWD(Implementation, memberName)

/// \brief Add a private UniqueImplPtr to a class as dataPtr.
///  This variant forward-declares Class::Implementation as the impl.
#define AEROZEN_UTILS_UNIQUE_IMPL_PTR(memberName) \
public:                                           \
    class Implementation;                         \
    AEROZEN_UTILS_UNIQUE_IMPL_PTR_FWD(Implementation, memberName)

#include "aerozen/utils/detail/impl_ptr.hpp"

#endif  // AEROZEN_UTILS_IMPL_PTR_HPP_
