...
TEST(RepStorageTest, RepStorageAPI)
{
  ...
  std::shared_ptr<RepHandler<msgs::Vector3d,
    msgs::Int32>> rep1HandlerPtr(new RepHandler<
  ...
  std::shared_ptr<RepHandler<msgs::Int32,
    msgs::Int32>> rep2HandlerPtr(new RepHandler
  ...
  // Create another REP handler without a callback for node1.
  std::shared_ptr<RepHandler<msgs::Int32,
    msgs::Int32>> rep5HandlerPtr(new RepHandler
      <msgs::Int32, msgs::Int32>(pUuid1, nUuid1));
  ...
  std::shared_ptr<RepHandler<msgs::Int32,
    msgs::Int32>> rep3HandlerPtr(new RepHandler
      <msgs::Int32, msgs::Int32>(pUuid1, nUuid1));
  ...
  std::shared_ptr<RepHandler<msgs::Int32,
    msgs::Int32>> rep4HandlerPtr(new RepHandler
      <msgs::Int32, msgs::Int32>(pUuid1, nUuid1));
...
TEST(RepStorageTest, SubStorageNoCallbacks)
{
  ...
  std::shared_ptr<SubscriptionHandler<msgs::Int32>>
    sub1HandlerPtr(new SubscriptionHandler
