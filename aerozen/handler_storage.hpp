...
class HandlerStorage
{
    ...
    using TopicServiceCalls_M = std::map<std::string, UUIDHandler_Collection_M>;
...
public:
    bool Handlers(
        ...
        std::map<std::string, std::map<std::string, std::shared_ptr<T>>>&
            _handlers) const {
...
public:
    bool Handler(const std::string& _topic, const std::string& _nUuid,
...
public:
    void AddHandler(const std::string& _topic, const std::string& _nUuid,
...
public:
    bool RemoveHandler(const std::string& _topic, const std::string& _nUuid,
