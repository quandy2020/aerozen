...
#ifndef AEROZEN_NODE_HPP_
#define AEROZEN_NODE_HPP_
...
public:
    ...
    public:
         ...
         */
        explicit Publisher(const MessagePublisher& _publisher);
         ...
         *
         * @note This function will deserialize the message when sending it to
    ...
    public:
         ...
         */
    private:
        std::shared_ptr<PublisherPrivate> dataPtr;
    };
    ...
    public:
         ...
         */
        Subscriber(const std::string& _topic, const std::string& _nUuid,
                   const NodeOptions& _nOpts, const std::string& _hUuid);
    ...
    private:
         ...
         * @brief Smart pointer to private data.
         */
        std::shared_ptr<SubscriberPrivate> dataPtr;
    };
     ...
     * (e.g. when using client mode without a reachable router).
     */
    explicit Node(const NodeOptions& _options);
     ...
     */
    Node::Publisher Advertise(
        const std::string& _topic, const std::string& _msgTypeName,
        const AdvertiseMessageOptions& _options = AdvertiseMessageOptions());
    ...
    bool Advertise(
        const std::string& _topic, bool (*_callback)(ReplyT& _reply),
        const AdvertiseServiceOptions& _options = AdvertiseServiceOptions());
    ...
    bool Advertise(
        const std::string& _topic, void (*_callback)(const RequestT& _request),
        const AdvertiseServiceOptions& _options = AdvertiseServiceOptions());
    ...
    bool Advertise(
        const std::string& _topic, bool (ClassT::*_callback)(ReplyT& _reply),
        ClassT* _obj,
        const AdvertiseServiceOptions& _options = AdvertiseServiceOptions());
    ...
    bool Advertise(
        const std::string& _topic,
        void (ClassT::*_callback)(const RequestT& _request), ClassT* _obj,
        const AdvertiseServiceOptions& _options = AdvertiseServiceOptions());
    ...
    template <typename RequestT, typename ReplyT>
    bool Request(const std::string& _topic, const RequestT& _request,
                 std::function<void(const ReplyT& _reply, const bool _result)>&
                     _callback);
    ...
    template <typename ClassT, typename RequestT, typename ReplyT>
    bool Request(const std::string& _topic, const RequestT& _request,
                 void (ClassT::*_callback)(const ReplyT& _reply,
                                           const bool _result),
                 ClassT* _obj);
    ...
    template <typename RequestT, typename ReplyT>
    bool Request(const std::string& _topic, const RequestT& _request,
                 const unsigned int& _timeout, ReplyT& _reply, bool& _result);
     ...
     */
    template <typename ReplyT>
    bool Request(const std::string& _topic, const unsigned int& _timeout,
     ...
     * expired.
     */
    bool RequestRaw(const std::string& _topic, const std::string& _request,
     ...
     */
    bool SubscribeRaw(const std::string& _topic, const RawCallback& _callback,
     ...
     */
    bool EnableStats(const std::string& _topic, bool _enable,
...
private:
     ...
     */
    std::unordered_set<std::string>& TopicsSubscribed() const;

    /**
     * @brief Get the set of services advertised by this node.
     * @return The set of advertised services.
     */
    std::unordered_set<std::string>& SrvsAdvertised() const;
    ...
    std::shared_ptr<SubscriptionHandler<MessageT>> SubscribeImpl(
        const std::string& _topic, void (*_callback)(const MessageT& _msg),
        const SubscribeOptions& _opts = SubscribeOptions());
    ...
    std::shared_ptr<SubscriptionHandler<MessageT>> SubscribeImpl(
        const std::string& _topic,
        void (ClassT::*_callback)(const MessageT& _msg), ClassT* _obj,
        const SubscribeOptions& _opts = SubscribeOptions());
    ...
    std::shared_ptr<SubscriptionHandler<MessageT>> SubscribeImpl(
        const std::string& _topic,
        std::function<void(const MessageT& _msg, const MessageInfo& _info)>
            _callback,
        const SubscribeOptions& _opts = SubscribeOptions());
    ...
    std::shared_ptr<SubscriptionHandler<MessageT>> SubscribeImpl(
        ...
        ClassT* _obj, const SubscribeOptions& _opts = SubscribeOptions());

    /**
     * @internal
     * @brief Smart pointer to private data.
     */
    std::unique_ptr<aerozen::NodePrivate> dataPtr;
};
}  // namespace aerozen

#include "aerozen/detail/node.hpp"

#endif  // AEROZEN_NODE_HPP_
