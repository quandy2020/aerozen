...
// void cb(const char *_data, size_t _size, const char *_msgType, void
// *_userData)
// {
...
//   EXPECT_EQ(0,
//     gzTransportPublishRaw(node, topic, buffer, size,
...
//   EXPECT_EQ(0,
//             gzTransportPublishRaw(node, topic, binaryData, dataSize,
//             msgType));
