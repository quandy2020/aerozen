...
#ifndef AEROZEN_LOG_TEST_INTEGRATION_CHIRPPARAMS_HH_
#define AEROZEN_LOG_TEST_INTEGRATION_CHIRPPARAMS_HH_
 ...
 * topics.
 */
using ChirpMsgType = aerozen::msgs::Int32;
 ...
 * aerozen::utils::Subprocess::Join().
 */
aerozen::utils::Subprocess BeginChirps(const std::vector<std::string>& _topics,
                                       const int _chirps,
