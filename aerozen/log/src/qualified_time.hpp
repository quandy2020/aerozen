...
public:
    QualifiedTime(QualifiedTime&& _old) = default;  // NOLINT

    /// \brief move assignment operator
    /// \return Reference to this object
public:
    QualifiedTime& operator=(QualifiedTime&&) = default;  // NOLINT(build/c++11)
...
public:
    ...
    /// \param[in] _old the instance being moved into this one
public:
    QualifiedTimeRange(QualifiedTimeRange&& _old);  // NOLINT

    /// \brief Default move assignment
    /// \return Reference to this object
public:
    QualifiedTimeRange& operator=(QualifiedTimeRange&&) =
        default;  // NOLINT(build/c++11)
