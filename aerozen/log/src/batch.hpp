...
private:
    std::unique_ptr<BatchPrivate> dataPtr;
#ifdef _WIN32
#pragma warning(pop)
#endif
    ...
    /// \internal
private:
    Batch(std::unique_ptr<BatchPrivate>&& _pimpl);  // NOLINT(build/c++11)
