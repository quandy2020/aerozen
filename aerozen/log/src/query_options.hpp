...
public:
    virtual std::vector<SqlStatement> GenerateStatements(
...
public:
    explicit TimeRangeOption(const QualifiedTimeRange& _timeRange);
...
public:
    ...
    /// \param[in] _other Another TimeRangeOption
public:
    TimeRangeOption(TimeRangeOption&& _other);  // NOLINT
...
class GZ_TRANSPORT_LOG_VISIBLE TopicList final : public virtual QueryOptions,
...
public:
    ...
    /// \param[in] _other Another TopicList
public:
    TopicList(TopicList&& _other);  // NOLINT(whitespace/operators)
...
public:
    std::vector<SqlStatement> GenerateStatements(
...
public:
    ...
    /// \param[in] _other Another TopicPattern
public:
    TopicPattern(TopicPattern&& _other);  // NOLINT
...
class GZ_TRANSPORT_LOG_VISIBLE AllTopics final : public virtual QueryOptions,
                                                 public virtual TimeRangeOption
{
...
public:
    ...
    /// \param[in] _other Another AllTopics
public:
    AllTopics(AllTopics&& _other);  // NOLINT(whitespace/operators)
