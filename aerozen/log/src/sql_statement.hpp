...
public:
    ...
    /// \param[in] _other Another SqlParameter
public:
    SqlParameter(SqlParameter&& _other);  // NOLINT
...
public:
    ...
    /// \return This object
public:
    SqlParameter& operator=(SqlParameter&& _other);  // NOLINT
