...
class gz::transport::log::MessagePrivate
{
    /// \brief Time received
public:
    std::chrono::nanoseconds timeReceived = 0ns;
...
//////////////////////////////////////////////////
Message::Message() : dataPtr(new MessagePrivate) {}

//////////////////////////////////////////////////
Message::Message(const std::chrono::nanoseconds& _timeRecv, const void* _data,
                 std::size_t _dataLen, const char* _type, std::size_t _typeLen,
