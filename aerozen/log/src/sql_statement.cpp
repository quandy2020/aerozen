...
{
public:
    Implementation() : type(ParamType::NULL_TYPE) {
        // Do nothing
    }
...
public:
    void Set(const int64_t _integer) {
...
//////////////////////////////////////////////////
SqlParameter::SqlParameter() : SqlParameter(nullptr) {
    // Do nothing
}

//////////////////////////////////////////////////
SqlParameter::SqlParameter(std::nullptr_t) : dataPtr(new Implementation) {
...
//////////////////////////////////////////////////
SqlParameter::SqlParameter(const double _real) : dataPtr(new Implementation) {
