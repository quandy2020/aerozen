...
#ifndef AEROZEN_WAITHELPERS_HPP_
#define AEROZEN_WAITHELPERS_HPP_
 ...
 * @note An _interval of zero causes busy-waiting. Use a positive
 ...
 */
bool WaitForService(
    const Node& _node, const std::string& _service,
    std::chrono::milliseconds _timeout = std::chrono::milliseconds(10000));
