...
function(_aerozen_setup_target_for_codecheck)
  ...
  # Rules for cppcheck
  set (CPPCHECK_RULES "-UM_PI --rule-file=${AEROZEN_CMAKE_CODECHECK_DIR}/header_guard.rule --rule-file=${AEROZEN_CMAKE_CODECHECK_DIR}/namespace_AZ.rule")
  ...
  if(Python3_Interpreter_FOUND)
    add_custom_target(cpplint
      COMMAND ${Python3_EXECUTABLE} ${AEROZEN_CMAKE_CODECHECK_DIR}/cpplint.py --extensions=cc,hh --quiet `${CPPCHECK_FIND}`
    )
