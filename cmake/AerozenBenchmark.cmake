...
# ------------
#
# _aerozen_add_version_info_target()
#
# Adds a target to generate build and system configuration information. This
# function is private to aerozen-cmake.
#
# aerozen_add_benchmarks()
#
...
#    include(AerozenBenchmark)
#
# 2. Add the benchmark
#    aerozen_add_benchmarks(SOURCES ${benchmark_sources_list})
#
...
function(_aerozen_add_version_info_target)
  ...
  add_custom_target(version_info_target
    COMMAND ${CMAKE_COMMAND}
      -Dinput_file=${AEROZEN_CMAKE_DIR}/version_info.json.in
      ...
      -P ${AEROZEN_CMAKE_DIR}/AerozenGenerateVersionInfo.cmake
  )
endfunction()

function(aerozen_add_benchmarks)
  ...
  add_custom_target(
    run_benchmarks
    COMMAND python3 ${AEROZEN_CMAKE_BENCHMARK_DIR}/run_benchmarks.py
