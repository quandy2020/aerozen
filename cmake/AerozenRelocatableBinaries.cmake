...
#################################################
# aerozen_add_get_install_prefix_impl(GET_INSTALL_PREFIX_FUNCTION <get_install_prefix_function>
...
# as following:
# * if the library is shared and AEROZEN_ENABLE_RELOCATABLE_INSTALL is ON, by extracting the
#   location of the shared library via dladdr, and computing the corresponding
#   install prefix from it
# * if the library is static or AEROZEN_ENABLE_RELOCATABLE_INSTALL is OFF, by using the exact
...
#
# To use this macro, please add aerozen_find_package(DL)
...
#          the install directory of the package. Example: aerozen::${AEROZEN_DESIGNATION}::getInstallPrefix
#
...
#          Example: aerozen/${AEROZEN_DESIGNATION}/InstallationDirectories.hh
#
...
#          Example: AEROZEN_${AEROZEN_DESIGNATION_UPPER}_INSTALL_PREFIX

macro(aerozen_add_get_install_prefix_impl)
  set(_options)
  set(_oneValueArgs
  ...
  set(_multiValueArgs )
  cmake_parse_arguments(aerozen_add_get_install_prefix_impl "${_options}" "${_oneValueArgs}" "${_multiValueArgs}" ${ARGN})

  if(NOT DEFINED aerozen_add_get_install_prefix_impl_GET_INSTALL_PREFIX_FUNCTION)
    message(FATAL_ERROR
      "aerozen_add_get_install_prefix_impl: missing parameter GET_INSTALL_PREFIX_FUNCTION")
  endif()

  if(NOT DEFINED aerozen_add_get_install_prefix_impl_GET_INSTALL_PREFIX_HEADER)
    message(FATAL_ERROR
      "aerozen_add_get_install_prefix_impl: missing parameter GET_INSTALL_PREFIX_HEADER")
  endif()

  if(NOT DEFINED aerozen_add_get_install_prefix_impl_OVERRIDE_INSTALL_PREFIX_ENV_VARIABLE)
    message(FATAL_ERROR
      "aerozen_add_get_install_prefix_impl: missing parameter OVERRIDE_INSTALL_PREFIX_ENV_VARIABLE")
  endif()

  if(NOT TARGET ${PROJECT_LIBRARY_TARGET_NAME})
    message(FATAL_ERROR
      "Target ${PROJECT_LIBRARY_TARGET_NAME} required by aerozen_add_get_install_prefix_impl\n"
      "does not exist.")
  endif()
  ...
  if(NOT (target_type STREQUAL "STATIC_LIBRARY" OR target_type STREQUAL "MODULE_LIBRARY" OR target_type STREQUAL "SHARED_LIBRARY"))
    message(FATAL_ERROR "aerozen_add_get_install_prefix_impl: library ${_library} is of unsupported type ${target_type}")
  endif()


  set(aerozen_add_get_install_prefix_impl_GENERATED_CPP
  ...
  option(AEROZEN_ENABLE_RELOCATABLE_INSTALL "If ON, enable the feature of providing a relocatable install prefix in shared library." OFF)

  if ((target_type STREQUAL "MODULE_LIBRARY" OR target_type STREQUAL "SHARED_LIBRARY") AND AEROZEN_ENABLE_RELOCATABLE_INSTALL)
    if(NOT TARGET ${DL_TARGET})
      message(FATAL_ERROR
        "aerozen_add_get_install_prefix_impl called without DL_TARGET defined,\n"
        "please add aerozen_find_package(DL) if you want to use aerozen_add_get_install_prefix_impl.")
    endif()
    ...
    file(GENERATE OUTPUT "${aerozen_add_get_install_prefix_impl_GENERATED_CPP}"
         CONTENT
"// This file is automatically generated by the aerozen_add_get_install_prefix_impl CMake macro.
...
#include <${aerozen_add_get_install_prefix_impl_GET_INSTALL_PREFIX_HEADER}>
...
std::string ${aerozen_add_get_install_prefix_impl_GET_INSTALL_PREFIX_FUNCTION}()
{
  if(const char* override_env_var = std::getenv(\"${aerozen_add_get_install_prefix_impl_OVERRIDE_INSTALL_PREFIX_ENV_VARIABLE}\"))
  {
  ...
  int res_val = dladdr(reinterpret_cast<void *>(&${aerozen_add_get_install_prefix_impl_GET_INSTALL_PREFIX_FUNCTION}), &address_info);
...
")
  ...
  # Add cpp to library
  target_sources(${PROJECT_LIBRARY_TARGET_NAME} PRIVATE ${aerozen_add_get_install_prefix_impl_GENERATED_CPP})
