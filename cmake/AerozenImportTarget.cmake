...
#
########################################
# aerozen_import_target(<package> [INTERFACE]
...
#
macro(aerozen_import_target package)

  if (NOT aerozen_import_target_skip_parsing)
    #------------------------------------
    ...
    #------------------------------------
    # Parse the arguments
    _aerozen_cmake_parse_arguments(aerozen_import_target "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})
  endif()
  ...
  if(NOT TARGET ${target_name})
    ...
    # provided.
    if(NOT aerozen_import_target_LIB_VAR)
      set(aerozen_import_target_LIB_VAR ${package}_LIBRARIES)
    endif()

    if(NOT aerozen_import_target_INCLUDE_VAR)
      set(aerozen_import_target_INCLUDE_VAR ${package}_INCLUDE_DIRS)
    endif()

    if(NOT aerozen_import_target_CFLAGS_VAR)
      set(aerozen_import_target_CFLAGS_VAR ${package}_CFLAGS)
    endif()
    ...
    if(NOT aerozen_import_target_INTERFACE)
    ...
    if(NOT aerozen_import_target_INTERFACE)
      ...
      if(${aerozen_import_target_LIB_VAR})
        _aerozen_sort_libraries(${target_name} ${${aerozen_import_target_LIB_VAR}})
      endif()
    ...
    if(${aerozen_import_target_LIB_VAR})
      set_target_properties(${target_name} PROPERTIES
        INTERFACE_LINK_LIBRARIES "${${aerozen_import_target_LIB_VAR}}")
    endif()

    if(${aerozen_import_target_INCLUDE_VAR})
      # TODO: In a later version of cmake, it should be possible to replace this
      # with
      #
      # target_include_directories(${target_name} INTERFACE ${${aerozen_import_target_INCLUDE_VAR}})
      #
      ...
      set_property(
        ...
        PROPERTY INTERFACE_INCLUDE_DIRECTORIES
          ${${aerozen_import_target_INCLUDE_VAR}})
    endif()

    if(${aerozen_import_target_CFLAGS_VAR})
      # TODO: See note above. We should eventually be able to replace this with
      # target_compile_options(${target_name} INTERFACE ${${aerozen_import_target_CFLAGS_VAR}})
      set_property(
        TARGET ${target_name}
        PROPERTY INTERFACE_COMPILE_OPTIONS
          ${${aerozen_import_target_CFLAGS_VAR}})
    endif()
...
function(_aerozen_sort_libraries target_name first_lib)
