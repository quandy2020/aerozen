...
#
# 3. Use the function AEROZEN_SETUP_TARGET_FOR_COVERAGE to create a custom make target
...
#
FUNCTION(aerozen_setup_target_for_coverage)
  ...
  #------------------------------------
  # Parse the arguments
  _aerozen_cmake_parse_arguments(aerozen_coverage "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})

  set(_outputname ${aerozen_coverage_OUTPUT_NAME})
  set(_targetname ${aerozen_coverage_TARGET_NAME})
  set(_testrunner ${aerozen_coverage_TEST_RUNNER})

  if(aerozen_coverage_BRANCH_COVERAGE)
...
ENDFUNCTION() # AEROZEN_SETUP_TARGET_FOR_COVERAGE
