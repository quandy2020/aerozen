...
if(AEROZEN_SANITIZER)
  append("-fno-omit-frame-pointer" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)

  unset(SANITIZER_SELECTED_FLAGS)

  if(UNIX)
    if(AEROZEN_SANITIZER MATCHES "([Aa]ddress)")
    ...
    if(AEROZEN_SANITIZER MATCHES "([Mm]emory([Ww]ith[Oo]rigins)?)")
    ...
    if(AEROZEN_SANITIZER MATCHES "([Uu]ndefined)")
    ...
    if(AEROZEN_SANITIZER MATCHES "([Tt]hread)")
    ...
    if(AEROZEN_SANITIZER MATCHES "([Ll]eak)")
    ...
    if(AEROZEN_SANITIZER MATCHES "([Cc][Ff][Ii])")
  ...
  elseif(MSVC)
    if(AEROZEN_SANITIZER MATCHES "([Aa]ddress)")
      ...
      message(
        FATAL_ERROR
          "This sanitizer not yet supported in the MSVC environment: ${AEROZEN_SANITIZER}"
      )
    endif()
  else()
    message(FATAL_ERROR "AEROZEN_SANITIZER is not supported on this platform.")
  endif()
