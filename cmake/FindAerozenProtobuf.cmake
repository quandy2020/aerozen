...
# This is a Aerozen wrapper for finding Protobuf. The purpose of this find
...
include(AerozenPkgConfig)
aerozen_pkg_config_entry(AerozenProtobuf "protobuf >= ${AerozenProtobuf_FIND_VERSION}")

find_package(Protobuf ${AerozenProtobuf_FIND_VERSION} QUIET CONFIG)

if(NOT ${Protobuf_FOUND})
  # If a config-file was not found, then fall back on the system-installed
  # find-module that comes with CMake.
  find_package(Protobuf ${AerozenProtobuf_FIND_VERSION})
endif()

set(AerozenProtobuf_missing_components "")
foreach(component ${AerozenProtobuf_FIND_COMPONENTS})
  ...
  if(NOT AerozenProtobuf_FIND_REQUIRED_${component})
    continue()
  endif()
  ...
  if((${component} STREQUAL "libprotobuf") OR (${component} STREQUAL "all"))
    if((NOT PROTOBUF_LIBRARY) AND (NOT TARGET protobuf::libprotobuf))
      ...
      aerozen_string_append(AerozenProtobuf_missing_components "libprotobuf" DELIM " ")
    endif()
  endif()
  ...
  if((${component} STREQUAL "libprotoc") OR (${component} STREQUAL "all"))
    if((NOT PROTOBUF_PROTOC_LIBRARY) AND (NOT TARGET protobuf::libprotoc))
      set(Protobuf_FOUND false)
      aerozen_string_append(AerozenProtobuf_missing_components "libprotoc" DELIM " ")
    endif()
  endif()
  ...
  if((${component} STREQUAL "protoc") OR (${component} STREQUAL "all"))
    if((NOT PROTOBUF_PROTOC_EXECUTABLE) AND (NOT TARGET protobuf::protoc))
      set(Protobuf_FOUND false)
      aerozen_string_append(AerozenProtobuf_missing_components "protoc" DELIM " ")
    endif()
  endif()

endforeach()

if(AerozenProtobuf_missing_components AND NOT AerozenProtobuf_FIND_QUIETLY)
  message(STATUS "Missing required protobuf components: ${AerozenProtobuf_missing_components}")
endif()

if(${Protobuf_FOUND})
  # If we have found Protobuf, then set the AerozenProtobuf_FOUND flag to true so
  # that aerozen_find_package(~) knows that we were successful.
  set(AerozenProtobuf_FOUND true)
  ...
  if(NOT TARGET protobuf::libprotobuf)
    aerozen_import_target(protobuf
