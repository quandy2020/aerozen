...
#################################################
# aerozen_string_append(<output_var> <value_to_append> [DELIM <delimiter>])
#
...
macro(aerozen_string_append output_var val)
  ...
  #------------------------------------
  # Parse the arguments
  _aerozen_cmake_parse_arguments(aerozen_string_append "PARENT_SCOPE;${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})

  if(aerozen_string_append_DELIM)
    set(delim "${aerozen_string_append_DELIM}")
  else()
    set(delim " ")
  endif()
  ...
  if(aerozen_string_append_PARENT_SCOPE)
