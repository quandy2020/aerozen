...
#
########################################
# aerozen_manual_search(<package> [INTERFACE]
...
# aerozen_pkg_check_modules_quiet call.
...
#
macro(aerozen_manual_search package)
  ...
  #------------------------------------
  # Parse the arguments
  _aerozen_cmake_parse_arguments(aerozen_manual_search "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})

  if(aerozen_manual_search_INTERFACE)
    set(_aerozen_manual_search_interface_option INTERFACE)
  else()
    set(_aerozen_manual_search_interface_option) # Intentionally blank
  endif()

  if(NOT aerozen_manual_search_HEADER_NAMES)
    set(aerozen_manual_search_HEADER_NAMES "${package}.h")
  endif()

  if(NOT aerozen_manual_search_LIBRARY_NAMES)
    set(aerozen_manual_search_LIBRARY_NAMES "${package}")
  endif()

  if(NOT aerozen_manual_search_TARGET_NAME)
    set(aerozen_manual_search_TARGET_NAME "${package}::${package}")
  endif()

  find_path(${package}_INCLUDE_DIRS
            NAMES ${aerozen_manual_search_HEADER_NAMES}
            PATH_SUFFIXES ${aerozen_manual_search_PATH_SUFFIXES})
  find_library(${package}_LIBRARIES
               NAMES ${aerozen_manual_search_LIBRARY_NAMES}
               PATH_SUFFIXES ${aerozen_manual_search_PATH_SUFFIXES})
  ...
  if(${package}_FOUND)
    ...
    aerozen_import_target(${package} ${_aerozen_manual_search_interface_option}
      TARGET_NAME ${aerozen_manual_search_TARGET_NAME})
  endif()
