...
#################################################
# aerozen_build_examples(
#     SOURCE_DIR <source_dir>
#     BINARY_DIR <binary_dir>
#
# Build examples for a aerozen project.
...
macro(aerozen_build_examples)
  ...
  if(NOT ${BUILD_EXAMPLES})
    ...
    #------------------------------------
    # Parse the arguments
    _aerozen_cmake_parse_arguments(aerozen_build_examples "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})

    set(aerozen_build_examples_CMAKE_PREFIX_PATH $ENV{CMAKE_PREFIX_PATH})

    if (aerozen_build_examples_CMAKE_PREFIX_PATH)
      ...
      string(REPLACE ":" ";" aerozen_build_examples_CMAKE_PREFIX_PATH ${aerozen_build_examples_CMAKE_PREFIX_PATH})
    endif()

    if (CMAKE_INSTALL_PREFIX)
      list(APPEND aerozen_build_examples_CMAKE_PREFIX_PATH ${CMAKE_INSTALL_PREFIX})
    endif()
    ...
    add_test(
      ...
      COMMAND ${CMAKE_COMMAND} -G${CMAKE_GENERATOR}
                               ...
                               "-DCMAKE_PREFIX_PATH=${aerozen_build_examples_CMAKE_PREFIX_PATH}"
                               -S ${aerozen_build_examples_SOURCE_DIR}
                               -B ${aerozen_build_examples_BINARY_DIR}
    )

    add_test(
      NAME EXAMPLES_Build_TEST
      COMMAND ${CMAKE_COMMAND} --build ${aerozen_build_examples_BINARY_DIR}
                               --config $<CONFIG>
    )
