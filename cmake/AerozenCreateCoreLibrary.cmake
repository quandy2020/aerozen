...
#################################################
# aerozen_create_core_library(SOURCES <sources>
...
#
function(aerozen_create_core_library)
  ...
  #------------------------------------
  # Parse the arguments
  cmake_parse_arguments(aerozen_create_core_library "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})

  if(aerozen_create_core_library_SOURCES)
    set(sources ${aerozen_create_core_library_SOURCES})
  elseif(NOT aerozen_create_core_library_INTERFACE)
    message(FATAL_ERROR "You must specify SOURCES for aerozen_create_core_library(~)!")
  endif()

  if(aerozen_create_core_library_INTERFACE)
  ...
  _aerozen_add_library_or_component(
    ...
    EXPORT_BASE AEROZEN_${AEROZEN_DESIGNATION_UPPER}
    SOURCES ${sources}
    ${interface_option})
  ...
  _aerozen_handle_cxx_standard(aerozen_create_core_library
  ...
  _aerozen_create_cmake_package(LEGACY_PROJECT_PREFIX ${aerozen_create_core_library_LEGACY_PROJECT_PREFIX})

  # Generate and install the core library's pkgconfig information
  _aerozen_create_pkgconfig()


  #------------------------------------
  # Pass back the target name if they ask for it.
  if(aerozen_create_core_library_GET_TARGET_NAME)
    set(${aerozen_create_core_library_GET_TARGET_NAME} ${PROJECT_LIBRARY_TARGET_NAME} PARENT_SCOPE)       
  endif()
