...
MACRO(aerozen_add_manpage_target)
...
ENDMACRO(aerozen_add_manpage_target)
...
IF (NOT RONN OR NOT GZIP)
  IF (NOT RONN)
    AEROZEN_BUILD_WARNING ("ronn not found, manpages won't be generated")
  ENDIF(NOT RONN)
  IF (NOT GZIP)
    AEROZEN_BUILD_WARNING ("gzip not found, manpages won't be generated")
  ENDIF(NOT GZIP)
  # empty macro
