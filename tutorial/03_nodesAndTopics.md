...
The communication in aerozen follows a pure distributed architecture.
...
consumes information. There are two ways to communicate in aerozen.
...
to use the environment variable `AEROZEN_PARTITION` for setting a custom
partition name.
